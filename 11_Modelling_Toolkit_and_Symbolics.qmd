...
::: {.callout-note}
ModelingToolkit is developing rapidly, which is great in terms of new features being added all the time. Unfortunately this also means syntax improvements are happening all the time, so you may need to check the [documentation](https://docs.sciml.ai/ModelingToolkit/stable/) from time to time to catch up with new developments and new syntax.
:::
