...
Unfortunately, this also implies that you would need to learn how to use several packages. This is were the SciML organisation again is very helpful. Their [Optimization](https://docs.sciml.ai/Optimization/stable/)^[This package was originally called GalacticOptim to indicate that it includes a galaxy of optimisers, but the name was shortened due to popular demand.] package provides a unified front-end for several other optimisation packages, including Optim, NLopt, BlackBoxOptim and all of the external solvers available to JuMP and Convex. There full [list](https://docs.sciml.ai/Optimization/stable/#Overview-of-the-Optimizers) includes several others as well. Optimizers can also be used with Flux - a deep learning package - to train neural networks.
